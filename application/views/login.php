      ...
      <div class="card-body">
        <form class="form-signin" action="<?php echo site_url('login/authentication')?>" method="post">
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="usernam" name="username" type="text" placeholder="Username">
          </div>
          <div class="form-group">
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="javascript:;">Register an Account</a>
          <a class="d-block small" href="javascript:;">Forgot Password?</a>
        </div>
      </div>
    </div>
  </div>
